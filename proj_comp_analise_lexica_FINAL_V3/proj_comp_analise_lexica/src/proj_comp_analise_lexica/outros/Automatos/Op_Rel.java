...
public class Op_Rel implements Automatos{
	...
	switch (estadoAtual) {
		...
		switch (c) {
		    case '=':
			estadoAtual = Q1;this.nomeTermo = "(op_atr)";break;
		    case '>':
		    case '<':
			estadoAtual = Q1;this.nomeTermo = "(op_rel)";break;
		    case '!':
			estadoAtual = Q1;this.nomeTermo = "(op_log)";break;
		    default:
			estadoQoutro = QOUTRO;
		}
	    break;
		...
		switch (c) {
		    case '=':
			estadoAtual = Q2;nomeTermo = "(op_rel)";break;
		    default:
			estadoQoutro = QOUTRO;
		}
	    break;
